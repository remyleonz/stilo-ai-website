...
NICHES = [
    dict(
        ...
        loom="2558bfb9c4fc419db9bbcb0e44d933c0",
    ...
    dict(
        ...
        loom="f3cc25a09e9c41c5b259feab0a409b28",
    ...
    dict(
        ...
        loom="501bdda7a0304e3b8534223489c34392",
    ...
    dict(
        ...
        loom="55a25c927eec46f7a91e756f18eae0e7",
    ...
    dict(
        ...
        loom="e55a0424e276441cbaf973fa2817ac75",
...
def build_page(tpl, n):
    ...
    hero = (
        ...
        '      <button type="button" class="vsl-play" onclick="startVsl(this)" '
        ...
        '    </div>\n'
        '  </div>\n'
        '</section>' % (n["h1"], n["name"], n["loom"], n["slug"], CTA)
    )
