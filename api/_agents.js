  ...
  ignite: {
    ...
    onboardingSchema: [
      { step: 1, fields: [
        { key: 'business_name', label: 'Business name', type: 'text', required: true, editable: true },
        { key: 'website', label: 'Website', type: 'url', editable: true },
        { key: 'industry', label: 'Industry / category', type: 'text', editable: true },
      ...
      { step: 2, fields: [
        { key: 'lead_email_inbox', label: 'Inbox where leads land today', type: 'email', required: true, editable: true,
          help: 'Where new lead emails arrive (web form, ad platform, etc.). IGNITE watches this inbox.' },
        { key: 'lead_sources', label: 'Where do leads come from?', type: 'textarea', editable: true,
          help: 'List your top sources. Example: "Instagram DMs, Google Form, Facebook Lead Ads".' },
